...
## งานค้าง — **ปิดครบทั้งหก 2026-08-03** (7 commit หลัง `a6aad20` · 494/494)

> เก็บรายการไว้ทั้งหมดพร้อมสิ่งที่พบระหว่างทาง เพราะหลายข้อกลายเป็นงานมากกว่าที่จดไว้
> · **ยังไม่ push และยังไม่ bump version** — ดูท้ายไฟล์
...
- **push 7 commit นี้แล้ว แต่จะ bump version ไหม** — Master สั่ง "ทำข้อ 4–6 ต่อก่อน
  แล้วค่อย push ทีเดียว" · ยังอยู่ที่ **0.14.0** · ถ้าไม่ bump งานจะขึ้น GitHub แต่
  **ไม่ถึงผู้ใช้** เพราะ install cache ผูกกับเวอร์ชัน · รอบนี้มีทั้งกฎ ledger ที่ปฏิเสธจริง
  พฤติกรรม CLI ที่เปลี่ยน และหน้าเว็บที่เปลี่ยน

...
```
A ซอร์สที่ ship  3/3 ตอบครบ · รอบ1 9 finding · รอบ2 7 finding   (แก้ทั้งหมด)
B เทสที่ค้ำ      3/3 ตอบครบ · 10 finding                          (แก้ 4 ที่เป็นเทสว่างเปล่า)
C เอกสาร+สัญญา   รอบ1 บล็อก — AGY เรียก read tool → เกตปฏิเสธทั้งใบ
                 รอบ2 กำลังรัน (เพิ่มกฎ "ห้ามเรียกเครื่องมือ" ลงในซอง)
```

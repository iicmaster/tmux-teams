...
- **อิชชูเปิดค้างใบเดียวโดยตั้งใจ** — เลน claude-routed รันใน bwrap ไม่ได้เพราะ
  `CLAUDE_CODE_EXECUTABLE` ไม่เคยถูก stage · โค้ดแก้ครบห้าชั้นแล้ว **แต่ยังไม่มีใครรันสามตระกูล
  ผ่านบน Linux สักครั้ง** — ที่เปิดอยู่คือ**การรัน** ไม่ใช่โค้ด
...
1. **เฟส C ที่ยังเปิด** — รันแผงสามตระกูลผ่าน bwrap บน Linux ให้ผ่านสักครั้ง · โค้ดครบแล้ว
   **ที่ขาดคือการรัน** · เตรียมโปรไฟล์ที่มีโทเค็นให้ครบก่อน (ดูตารางจุดล้มนอกโค้ดข้างบน)

...
เพราะ `setup_status` ของ artifact-sftp ตอบ NOT READY จาก **paramiko ที่ไม่มีใน venv ของ `uv run`**
(ดูหัวข้อ roadmap ข้างบน · แก้ที่เรพอื่น ต้องขออนุญาต) · **รีลีสหน้าจะสะดุดกับมันเอง**

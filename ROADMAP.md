...
Current release: **0.39.0** — the version stamped in this tree, in flight on
a pull request and not yet tagged. `main` carries **v0.38.0**, tagged at the
MERGED sha `e9ed44d` (not the branch tip `aa7e302` — those are different

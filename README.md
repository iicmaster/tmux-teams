...
Current release: **0.42.0** (`.claude-plugin/marketplace.json` and
...
| `tmux-teams:codex-advisor` | you want a read from outside the Claude family — `gpt-6-sol` by default at `max`, or `astra` / `luna` at `ultra` |

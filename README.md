...
Current release: **0.39.0** (`.claude-plugin/marketplace.json` and
...
| `tmux-teams:codex-advisor` | you want a read from outside the Claude family — `gpt-5.6-sol` by default, or `astra` / `luna` / `terra`, always at `ultra` |
